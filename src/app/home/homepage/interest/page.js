...
export default function HomePage() {
    ...
    const matchedResults = results.filter(result => result.matchesUserInterest && (selectedCategory === 'All' || result.category === selectedCategory));

    return (
        <div>
            <h1 className='text-xl font-semibold mb-4 ml-10'>Your Interests All Time</h1>
            <div className='flex flex-col text-black pb-20 px-12 h-screen overflow-y-auto'>
                ...
                <div className='overflow-x-auto mt-4'>
                    {matchedResults.length > 0 ? (
                        <div>
                            <p className="mb-2 text-sm absolute right-20 top-20 text-gray-600">Number of matched results: {matchedResults.length}</p>
