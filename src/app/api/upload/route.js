...
export async function POST(request) {
    try {
        ...
        const insertProjectTopicQuery = 'INSERT INTO project_topic (past_topics_id, past_fyp_topics, past_fyp_year) VALUES (?, ?, ?)';
        ...
        for (const row of data) {
            ...
            const [pastTopicsId, pastFypTopics, pastFypYear] = row;
            ...
            await db.execute(insertProjectTopicQuery, [pastTopicsId, pastFypTopics, pastFypYear]);
        }
